...
public class BuildVars {
    ...
    public static boolean LOGS_ENABLED = BladeConfig.getLogging();
    ...
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=com.bladegram.messenger";
