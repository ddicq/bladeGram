...
public class SenderSelectView extends View {
    ...
    public SenderSelectView(Context context) {
        super(context);
        avatarImage.setRoundRadius(BladeConfig.getAvatarCorners(32));
    ...
    private void updateColors() {
        ...
        selectorDrawable = Theme.createSimpleSelectorRoundRectDrawable(BladeConfig.getAvatarCorners(32), Color.TRANSPARENT, Theme.getColor(Theme.key_windowBackgroundWhite));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(0, 0, getWidth(), getHeight(), BladeConfig.getAvatarCorners(getWidth(), true), BladeConfig.getAvatarCorners(getWidth(), true), backgroundPaint);
