...
public class ViewPagerFixed extends FrameLayout {
    ...
    public static class TabsView extends FrameLayout {
        ...
        public TabsView(Context context, boolean hasStableIds, int tabsSelectorType, Theme.ResourcesProvider resourcesProvider) {
            ...
            selectorDrawable.setColor(ColorUtils.setAlphaComponent(Theme.getColor(tabLineColorKey, resourcesProvider), BladeConfig.tabStyle >= 3 ? 0x2F : 0xFF));
            ...
            listView.setSelectorType(BladeConfig.tabStyle >= 3 ? 100 : tabsSelectorType);
            if (tabsSelectorType < 3) listView.setSelectorRadius(6);
            listView.setSelectorDrawableColor(BladeConfig.tabStyle >= 3 ? 0x00 : Theme.getColor(selectorColorKey, resourcesProvider));
            ...
            if (child == listView) {
                ...
                if (indicatorWidth != 0) {
                    ...
                    selectorDrawable.setBounds(
                            indicatorX - (BladeConfig.tabStyle == 3 ? AndroidUtilities.dp(10) : BladeConfig.tabStyle == 4 ? AndroidUtilities.dp(12) : 0),
                            (int) (BladeConfig.tabStyle >= 3 ? height / 2 - AndroidUtilities.dp(BladeConfig.tabStyle == 3 ? 17 : 18) * (1f - hideProgress) : height - AndroidUtilities.dpr(4) + hideProgress * AndroidUtilities.dpr(4)),
                            indicatorX + indicatorWidth + (BladeConfig.tabStyle == 3 ? AndroidUtilities.dp(10) : BladeConfig.tabStyle == 4 ? AndroidUtilities.dp(12) : 0),
                            (int) (BladeConfig.tabStyle >= 3 ? height / 2 + AndroidUtilities.dp(BladeConfig.tabStyle == 3 ? 17 : 18) * (1f - hideProgress) : height + hideProgress * AndroidUtilities.dpr(4)));
